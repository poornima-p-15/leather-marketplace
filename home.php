...
<body>
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
        <ul class="navbar-nav">
          ...
          <li class="nav-item"><a class="nav-link" href="post-ad.html">Sell</a></li>
  ...
  <section class="banner">
    <div class="container">
      ...
      <a href="listings.php" class="btn btn-custom">Browse Listings</a>
    </div>
  </section>
  ...
  <div class="container text-center mt-5 pt-5">
    ...
    <form action="listings.php" method="GET" class="search-box mb-4">
    ...
    <div class="row g-4 justify-content-center">
      ...
      <div class="breadcrumb">
        <span>Home</span> &RightArrow; <a href="listings.php">View All</a>
      </div>
    </div>
...
<div class="breadcrumb">
        <span>Home</span> &RightArrow; <a href="post-ad.php">Sell on Leathora</a>
      </div>
  </div>
